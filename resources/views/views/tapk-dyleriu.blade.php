    ...
    <div class="row">
        <div class="itemContainer">
            <div class="photo-container">
                <img class="grow-in-entrance PhotoItself" src="{{asset('images/ourwork/AUDIA7.png')}}"/>
                <div class="overlay">
                    <div class="text">AUDIA7</div>
                </div>
            </div>
                <div class="photo-container">
                <img class="grow-in-entrance PhotoItself" src="{{asset('images/ourwork/AUDIRS7.png')}}"/>
                <div class="overlay">
                    <div class="text">AUDIRS7</div>
                </div>
            </div>
            <div class="photo-container">
                <img class="grow-in-entrance PhotoItself" src="{{asset('images/ourwork/AUDIS6.png')}}"/>
                <div class="overlay">
                    <div class="text">AUDIS6</div>
                </div>
            </div>
            <div class="photo-container">
                <img class="grow-in-entrance PhotoItself" src="{{asset('images/ourwork/BMW428i.png')}}"/>
                <div class="overlay">
